# Generated by Django 2.1.7 on 2019-05-01 12:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload', models.ImageField(default='static/default/default_avatar.png', upload_to='uploads/%Y/%m/%d/', verbose_name="User's Avatar")),
        ...
        migrations.AddField(
            model_name='question',
            name='tags',
            field=models.ManyToManyField(default=True, related_name='questions', to='question.Tag', verbose_name="Question's Tags"),
        ),
        migrations.AddField(
            model_name='answer',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='question.Question', verbose_name="Answer's Question"),
        ),
    ]
